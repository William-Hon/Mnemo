              ...
              <View className="flex-col gap-3 pl-1">
                <View className="flex-row">
                  ...
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">AES-256-GCM Encryption:</Text> Journal text is encrypted before database storage.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Device-Generated Keys:</Text> Each user receives a randomly generated Master Encryption Key (MEK).
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Protected Keys:</Text> A user passphrase derives a separate Key Encryption Key (KEK) using PBKDF2, which protects the MEK.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Encrypted Storage:</Text> Supabase/PostgreSQL stores encrypted journal text rather than readable entries.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Temporary Processing:</Text> Cloud features can briefly decrypt only the required data in memory for operations such as embedding generation, without permanently storing the plaintext.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Private AI:</Text> LLM inference can run locally, keeping retrieved journal context on the user's device.
                  </Text>
                </View>
              </View>
              <Text className="text-gray-500 dark:text-gray-500 leading-relaxed text-sm mt-4 italic">
            ...
            <View className="mt-5 pt-5 border-t border-gray-100 dark:border-gray-800">
              ...
              <View className="flex-col gap-3 pl-1">
                ...
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    An <Text className="font-bold dark:text-gray-300">embedding model</Text> converts their meaning into vectors stored with <Text className="font-bold dark:text-gray-300">PostgreSQL + pgvector</Text>.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                ...
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Reciprocal Rank Fusion (RRF)</Text> combines semantic and keyword rankings for stronger retrieval.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
            ...
            <View className="mt-5 pt-5 border-t border-gray-100 dark:border-gray-800">
              ...
              <View className="flex-col gap-3 pl-1">
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Local Inference:</Text> Retrieved memories can be analyzed without sending them to ChatGPT, Claude, or another cloud LLM.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">WebGPU Acceleration:</Text> Supported devices use local GPU hardware to accelerate inference.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Model Delivery APIs:</Text> Dedicated APIs handle downloading and managing model artifacts from cloud/CDN infrastructure.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Persistent Model Caching:</Text> The model is downloaded once and reused between sessions.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Model Preloading:</Text> Initialization begins before the user starts a conversation to reduce first-response latency.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">KV-Cache Reuse:</Text> Previously processed context remains cached so the LLM does not repeatedly recompute the same journal information.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Prompt Engineering:</Text> Structured prompts combine retrieved memories with user questions while keeping the model grounded in actual journal data.
                  </Text>
                </View>
              </View>
              <Text className="text-gray-500 dark:text-gray-500 leading-relaxed text-sm mt-4 italic">
            ...
            <View className="mt-5 pt-5 border-t border-gray-100 dark:border-gray-800">
              ...
              <View className="flex-col gap-3 pl-1">
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    Audio is uploaded through authenticated <Text className="font-bold dark:text-gray-300">APIs</Text> to private storage.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    <Text className="font-bold dark:text-gray-300">Groq Whisper</Text> performs speech-to-text transcription.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                ...
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
                  <Text className="text-gray-600 dark:text-gray-400 leading-relaxed text-base flex-1">
                    Transcribed entries automatically enter the same embedding and <Text className="font-bold dark:text-gray-300">RAG retrieval pipeline</Text> as typed entries.
                  </Text>
                </View>
                <View className="flex-row">
                  <Text className="text-gray-400 dark:text-gray-500 mr-3 text-lg leading-6">•</Text>
